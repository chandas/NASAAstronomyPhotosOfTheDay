...
import static com.org.skc.astronomypictureoftheday.utils.Constants.FAV_ITEM_URL;
import static com.org.skc.astronomypictureoftheday.utils.Constants.NIGHT_MODE;
import static com.org.skc.astronomypictureoftheday.utils.Constants.SHARED_PREFS;
...
import com.org.skc.astronomypictureoftheday.utils.Constants;
import com.org.skc.astronomypictureoftheday.utils.DatePickerFragment;
...
public class MainActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    private ImageView mImageViewSelectDate;
    ...
    private static final String mUrlRequestDefaultKey = "https://api.nasa.gov/planetary/apod?api_key=" + Constants.CONST_API_KEY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageViewSelectDate = findViewById(R.id.selectDateButton);
        mImageViewSelectDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mTextViewDatePicker.setText(getString(R.string.click_calendar_text));
    }
    ...
    private void saveDataIntoFavoriteList() {
        ...
        editor.putString(FAV_ITEM_URL, mUrlRequestForJson);
    ...
    private void loadDataIntoFavoriteList() {
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        mUrlRequestForJsonFavorites = sharedPreferences.getString(FAV_ITEM_URL, "true");
        Log.d(TAG, "mUrlRequestForJsonFavorites: " + mUrlRequestForJsonFavorites);
    }
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, mUrlRequestForJson, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        mImageViewSelectDate.setEnabled(false);
    ...
    private void openRecyclerViewActivity() {
        Intent intent = new Intent(this, FavItemsListActivity.class);
